...
export const SteamIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2a10 10 0 0 0-9.95 9.04l5.53 2.28a2.83 2.83 0 0 1 1.6-.49c.06 0 .11 0 .17.01l2.4-3.47v-.05a3.78 3.78 0 1 1 3.78 3.78h-.09l-3.42 2.44c0 .06.01.11.01.17a2.85 2.85 0 0 1-5.68.25L2.1 14.34A10 10 0 1 0 12 2z" />
  </svg>
)
